...
docker run -d \
  ...
  ghcr.io/2464693633/sub2api:latest
```
...
services:
  sub2api:
    image: ghcr.io/2464693633/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/2464693633/sub2api)
- [Documentation](https://github.com/2464693633/sub2api#readme)
