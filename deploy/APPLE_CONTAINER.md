...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/2464693633/sub2api:latest
...
SUB2API_IMAGE=ghcr.io/2464693633/sub2api:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
