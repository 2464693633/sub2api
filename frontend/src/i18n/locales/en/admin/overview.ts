export default {
    ...
    groups: {
      ...
      form: {
        ...
        tokenBillingTitle: 'Token Metering',
        tokenBillingDescription: 'Adjust the token counts used for customer usage records and billing',
        inputTokenMultiplier: 'Input Token Multiplier',
        outputTokenMultiplier: 'Output Token Multiplier',
        cacheCreationTokenMultiplier: 'Cache Creation Token Multiplier',
        cacheReadTokenMultiplier: 'Cache Read Token Multiplier',
        returnBillableUsage: 'Return Billable Tokens in API Usage',
        returnBillableUsageHint: 'HTTP JSON/SSE responses return billable tokens; required for chained sub2api deployments; WebSocket usage remains raw',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
