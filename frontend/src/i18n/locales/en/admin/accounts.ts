export default {
    accounts: {
      ...
      health: {
        hint: 'Rolling-window monitoring data. Format: first-token latency · success count. With health sorting enabled, accounts with no recent failures and faster first tokens are preferred within the same priority. Non-zero failure counts are shown in red.',
        okShort: '{ok} ok',
        failedShort: '{failed} failed'
      },
