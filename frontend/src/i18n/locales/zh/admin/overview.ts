export default {
    ...
    groups: {
      ...
      form: {
        ...
        tokenBillingTitle: 'Token 计量',
        tokenBillingDescription: '分别调整客户使用记录和计费使用的 Token 数量',
        inputTokenMultiplier: '输入 Token 倍率',
        outputTokenMultiplier: '输出 Token 倍率',
        cacheCreationTokenMultiplier: '缓存创建 Token 倍率',
        cacheReadTokenMultiplier: '缓存读取 Token 倍率',
        returnBillableUsage: 'API 返回计费 Token',
        returnBillableUsageHint: '开启后，HTTP JSON/SSE 响应返回计费 Token；串联下游 sub2api 时必须开启，WebSocket 暂保持原始 Token',
        rpmLimit: '每分钟请求数 (RPM)',
        rpmLimitPlaceholder: '0 表示不限制',
