...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		cacheCreation5m           int
		cacheCreation1h           int
		billableInputTokens       sql.NullInt64
		billableOutputTokens      sql.NullInt64
		billableCacheCreation     sql.NullInt64
		billableCacheRead         sql.NullInt64
		inputTokenMultiplier      sql.NullFloat64
		outputTokenMultiplier     sql.NullFloat64
	...
	log := &service.UsageLog{
		...
		BillableInputTokens:          nullIntPtr(billableInputTokens),
		BillableOutputTokens:         nullIntPtr(billableOutputTokens),
		BillableCacheCreationTokens:  nullIntPtr(billableCacheCreation),
		BillableCacheReadTokens:      nullIntPtr(billableCacheRead),
		InputTokenMultiplier:         nullFloat64Ptr(inputTokenMultiplier),
		OutputTokenMultiplier:        nullFloat64Ptr(outputTokenMultiplier),
		CacheCreationTokenMultiplier: nullFloat64Ptr(cacheCreationMultiplier),
		CacheReadTokenMultiplier:     nullFloat64Ptr(cacheReadMultiplier),
