...
func RegisterGatewayRoutes(
	...
	gateway.Use(billableUsageResponse)
	...
	gemini.Use(billableUsageResponse)
	...
	rootRoute := func(method, path string, limit gin.HandlerFunc, handler gin.HandlerFunc) {
		r.Handle(method, path, limit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), billableUsageResponse, groupModelAllowlist, compositeTarget, requireGroupAnthropic, handler)
	}
	...
	codexDirect.Use(bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), billableUsageResponse, groupModelAllowlist, compositeTarget, requireGroupAnthropic)
	{
	...
	antigravityV1.Use(billableUsageResponse)
	...
	antigravityV1Beta.Use(billableUsageResponse)
