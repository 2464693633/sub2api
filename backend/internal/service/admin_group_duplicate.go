...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		InputTokenMultiplier:            source.InputTokenMultiplier,
		OutputTokenMultiplier:           source.OutputTokenMultiplier,
		CacheCreationTokenMultiplier:    source.CacheCreationTokenMultiplier,
		CacheReadTokenMultiplier:        source.CacheReadTokenMultiplier,
		ReturnBillableUsage:             source.ReturnBillableUsage,
		TokenMultipliersConfigured:      source.TokenMultipliersConfigured,
