...
func init() {
	...
	// groupDescInputTokenMultiplier is the schema descriptor for input_token_multiplier field.
	groupDescInputTokenMultiplier := groupFields[3].Descriptor()
	// group.DefaultInputTokenMultiplier holds the default value on creation for the input_token_multiplier field.
	group.DefaultInputTokenMultiplier = groupDescInputTokenMultiplier.Default.(float64)
	// group.InputTokenMultiplierValidator is a validator for the "input_token_multiplier" field. It is called by the builders before save.
	group.InputTokenMultiplierValidator = func() func(float64) error {
		validators := groupDescInputTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
		return func(input_token_multiplier float64) error {
			for _, fn := range fns {
				if err := fn(input_token_multiplier); err != nil {
					return err
				}
			}
			return nil
	...
	// groupDescOutputTokenMultiplier is the schema descriptor for output_token_multiplier field.
	groupDescOutputTokenMultiplier := groupFields[4].Descriptor()
	// group.DefaultOutputTokenMultiplier holds the default value on creation for the output_token_multiplier field.
	group.DefaultOutputTokenMultiplier = groupDescOutputTokenMultiplier.Default.(float64)
	// group.OutputTokenMultiplierValidator is a validator for the "output_token_multiplier" field. It is called by the builders before save.
	group.OutputTokenMultiplierValidator = func() func(float64) error {
		validators := groupDescOutputTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
		return func(output_token_multiplier float64) error {
			for _, fn := range fns {
				if err := fn(output_token_multiplier); err != nil {
					return err
				}
			}
			return nil
	...
	// groupDescCacheCreationTokenMultiplier is the schema descriptor for cache_creation_token_multiplier field.
	groupDescCacheCreationTokenMultiplier := groupFields[5].Descriptor()
	// group.DefaultCacheCreationTokenMultiplier holds the default value on creation for the cache_creation_token_multiplier field.
	group.DefaultCacheCreationTokenMultiplier = groupDescCacheCreationTokenMultiplier.Default.(float64)
	// group.CacheCreationTokenMultiplierValidator is a validator for the "cache_creation_token_multiplier" field. It is called by the builders before save.
	group.CacheCreationTokenMultiplierValidator = func() func(float64) error {
		validators := groupDescCacheCreationTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
		return func(cache_creation_token_multiplier float64) error {
			for _, fn := range fns {
				if err := fn(cache_creation_token_multiplier); err != nil {
					return err
				}
			}
			return nil
	...
	// groupDescCacheReadTokenMultiplier is the schema descriptor for cache_read_token_multiplier field.
	groupDescCacheReadTokenMultiplier := groupFields[6].Descriptor()
	// group.DefaultCacheReadTokenMultiplier holds the default value on creation for the cache_read_token_multiplier field.
	group.DefaultCacheReadTokenMultiplier = groupDescCacheReadTokenMultiplier.Default.(float64)
	// group.CacheReadTokenMultiplierValidator is a validator for the "cache_read_token_multiplier" field. It is called by the builders before save.
	group.CacheReadTokenMultiplierValidator = func() func(float64) error {
		validators := groupDescCacheReadTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
		return func(cache_read_token_multiplier float64) error {
			for _, fn := range fns {
				if err := fn(cache_read_token_multiplier); err != nil {
					return err
				}
			}
			return nil
	...
	// groupDescReturnBillableUsage is the schema descriptor for return_billable_usage field.
	groupDescReturnBillableUsage := groupFields[7].Descriptor()
	// group.DefaultReturnBillableUsage holds the default value on creation for the return_billable_usage field.
	group.DefaultReturnBillableUsage = groupDescReturnBillableUsage.Default.(bool)
	...
	// usagelogDescInputTokenMultiplier is the schema descriptor for input_token_multiplier field.
	usagelogDescInputTokenMultiplier := usagelogFields[25].Descriptor()
	// usagelog.InputTokenMultiplierValidator is a validator for the "input_token_multiplier" field. It is called by the builders before save.
	usagelog.InputTokenMultiplierValidator = func() func(float64) error {
		validators := usagelogDescInputTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
	...
	// usagelogDescOutputTokenMultiplier is the schema descriptor for output_token_multiplier field.
	usagelogDescOutputTokenMultiplier := usagelogFields[26].Descriptor()
	// usagelog.OutputTokenMultiplierValidator is a validator for the "output_token_multiplier" field. It is called by the builders before save.
	usagelog.OutputTokenMultiplierValidator = func() func(float64) error {
		validators := usagelogDescOutputTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
	...
	// usagelogDescCacheCreationTokenMultiplier is the schema descriptor for cache_creation_token_multiplier field.
	usagelogDescCacheCreationTokenMultiplier := usagelogFields[27].Descriptor()
	// usagelog.CacheCreationTokenMultiplierValidator is a validator for the "cache_creation_token_multiplier" field. It is called by the builders before save.
	usagelog.CacheCreationTokenMultiplierValidator = func() func(float64) error {
		validators := usagelogDescCacheCreationTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
	...
	// usagelogDescCacheReadTokenMultiplier is the schema descriptor for cache_read_token_multiplier field.
	usagelogDescCacheReadTokenMultiplier := usagelogFields[28].Descriptor()
	// usagelog.CacheReadTokenMultiplierValidator is a validator for the "cache_read_token_multiplier" field. It is called by the builders before save.
	usagelog.CacheReadTokenMultiplierValidator = func() func(float64) error {
		validators := usagelogDescCacheReadTokenMultiplier.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
	...
	usagelogDescInputCost := usagelogFields[29].Descriptor()
	...
	usagelogDescOutputCost := usagelogFields[30].Descriptor()
	...
	usagelogDescCacheCreationCost := usagelogFields[31].Descriptor()
	...
	usagelogDescCacheReadCost := usagelogFields[32].Descriptor()
	...
	usagelogDescTotalCost := usagelogFields[33].Descriptor()
	...
	usagelogDescActualCost := usagelogFields[34].Descriptor()
