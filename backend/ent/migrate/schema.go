...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "input_token_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "output_token_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "cache_creation_token_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "cache_read_token_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "return_billable_usage", Type: field.TypeBool, Default: false},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "billable_input_tokens", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "bigint"}},
		{Name: "billable_output_tokens", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "bigint"}},
		{Name: "billable_cache_creation_tokens", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "bigint"}},
		{Name: "billable_cache_read_tokens", Type: field.TypeInt, Nullable: true, SchemaType: map[string]string{"postgres": "bigint"}},
		{Name: "input_token_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "output_token_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "cache_creation_token_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "cache_read_token_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
